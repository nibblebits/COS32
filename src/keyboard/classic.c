...
static uint8_t keyboard_special_keys_set_one[KEYBOARD_TOTAL_SPECIAL_KEYS] = {
    0x3B, 0x3C, 0x3D, 0x3E, 0x3F, 0x3F, 0x40, 0x41, 0x43, 0x44, 0x57, 0x58, 0x3A, 0x00, 0x00, 0x48, 0x50
};
